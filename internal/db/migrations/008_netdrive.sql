-- 迁移 v8：新建 settings 杂项参数表（存 115 Cookie 等键值对，便于后续扩展）；
-- background_tasks.kind 增加 netdrive_sha1（115 网盘补齐 SHA1 任务，独立队列）。
...
-- 重建 background_tasks（kind CHECK 增加 netdrive_sha1）
